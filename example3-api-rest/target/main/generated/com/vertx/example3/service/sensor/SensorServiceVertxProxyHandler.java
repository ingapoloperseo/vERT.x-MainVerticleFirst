...
public class SensorServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "saveSensor": {
          service.saveSensor(json.getJsonObject("dto") == null ? null : new com.vertx.example3.service.sensor.dto.SensorDTO(json.getJsonObject("dto")), res -> {
            if (res.failed()) {
        ...
        case "getSensor": {
          service.getSensor((java.lang.String)json.getValue("id"), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
        ...
        case "removeSensor": {
          service.removeSensor((java.lang.String)json.getValue("id"), createHandler(msg));
          break;
        }
        default: {
